	...
	<body>
		...
		<%
			String target="Registerform.jsp?status=Registration Failed"; 
		        ...
		        rb.setBirthDate(request.getParameter("day")+"-"+request.getParameter("Mon")+"-"+request.getParameter("year")); 
		        ...
		        if(flag) { 
		           target = "LoginForm.jsp?status="+name+", Registered Successfully"; 
		           target = "LoginForm.jsp?ls="+name+", Registered Successfully"; 
		           }
		        else  
